...
public class PartIII {
    void processGenes(StorageResource sr){
        ...
        System.out.println("the Strings in sr that are longer than 60 characters");
        for(String z : longer9.data()){
    ...
    void testing(){
        FileResource fr = new FileResource("C:\\Users\\Mohamed Mashaal\\Desktop\\Java Specialisation\\Course II\\Week 2\\DNA.txt");
